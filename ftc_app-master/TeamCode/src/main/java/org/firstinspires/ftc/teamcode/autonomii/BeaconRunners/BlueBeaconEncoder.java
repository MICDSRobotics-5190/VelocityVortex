...
@Autonomous(name="BlueBeaconEncoder",group="EncoderBeacons")
public class BlueBeaconEncoder extends LinearOpMode implements EncoderValues {
    private Robot bot;
        ...
        while (opModeIsActive()) {
            ...
            switch (step) {
                case 0 :
                    ...
                    break;
                case 1 :
                    if (gyro.getHeading() < 85 || gyro.getHeading() > 340) {
